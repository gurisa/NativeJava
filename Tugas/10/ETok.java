...
public class ETok extends Toko {
  ...
  ETok() {
    ...
    //keyword super untuk mengubah konstruktor parent inisialisasi ETok (Gurisa Devs).
    /*
  ...
  public static void main(String[] args) { //program utama
    ...
    do {
      ...
      System.out.print("4. Belanja Tunai (development!)\n");
      System.out.print("5. Tentang ETok\n");
      ...
      switch (menu) {
        ...
        case 3 : barang_1.informasi_barang();
                 barang_2.informasi_barang();
                 break;
        case 4 : trx++; belanja_tunai(trx); break;

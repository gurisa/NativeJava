...
Toko.java = Kelas dan Metode Abstrak, Konstruktor
Transaksi.java = Implement Interface
Barang.java = Enkapsulasi, Getter dan Setter, Keyword This
ETok.java = Pewarisan, Variabel Static, Metode Generik, Konstruktor, Array of Object
Galat.java = 
Interfaces.java = Interface
Konsumen.java = Implement Interface
Menu.java = 
Operations.java = Kelas dan Metode Generik